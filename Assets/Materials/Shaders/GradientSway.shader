/**
 * Gradient shader: https://forum.unity.com/threads/height-based-gradient-shader.486727/
 * Swaying shader: https://twitter.com/minionsart/status/894576554411470848?lang=en
 */
Shader "Custom/GradientSway" {
	Properties {
